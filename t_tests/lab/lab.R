...
wm = read.table("data.tsv", header = T)
...
# - Gain was only two points (1.975) but was significant (p < .05)
# - DoF = 39, 40 subjects total
...
# Slightly larger effect (d = 1.62)
#   - is it **significantly** greater than 1.42?
#   - need mixed factorial anova and look for signifcance in interaction OR
#   - independent t-test on gain scores
...
# ** Assuming homegeneity of variance holds **
...
# Boxplot
#   - gain increases as function of # of training sessions
...
# Proportion of variance in gain score accounted for by treatment (58%)
